  ...
  return (
    <section className='container ContainerLoQueHacemos'>
        ...
        <div className="row containerCards">
            <div className="col columnaCards">
                <figure className='containerCard'>
                    <CarrouselSec3 img1={tabletas} img2={trufas} img3={bombones} ref1="Tabletas" ref2="Trufas" ref3="Bombones" />
                    <InfoCarrousel tit="Chocolates" parr="Disfruta de nuestra gran variedad de bombones, trufas, habanos y
        ...
        secos, deshidratados y rellenos caseros." />
            ...
            <div className="col columnaCards">
                <figure className='containerCard'>
                    <CarrouselSec3 img1={chocoManjar} img2={quequeFrutado} img3={redvelvet} ref1="Choco Manjar" ref2="Queque Frutado" ref3="Red Velvet" />
                    <InfoCarrousel tit="Pasteles" parr="Crea dulces momentos con nuestras tortas, queques caseros, pyes y chessecakes, elaborados con una fina selección de ingredientes y cremas que potencian cada sabor para un máximo disfrute." />
                </figure>
            </div>
        </div>
        <div className="row containerCards">
            <div className="col columnaCards">
                <figure className='containerCard'>
                    <CarrouselSec3 img1={alfajores} img2={brownies} img3={cupcakes} ref1="Alfajores" ref2="Brownies" ref3="Cupcakes" />
                    <InfoCarrousel tit="Bocaditos" parr="El complemento ideal para todo momento especial. 
Deléitate con nuestros alfajores, cupcakes y bocaditos salados pensados especialmente para ti." />
                </figure>
            </div>
            <div className="col columnaCards">
                <figure className='containerCard'>
                    <CarrouselSec3 img1={giftBox1} img2={giftBox2} img3={giftBox3} ref1="Gift Box" ref2="Gift Box" ref3="Gift Box" />
                    <InfoCarrousel tit="Gift Box" parr="Sorprende con estás bellas cajas de regalo, únicas y especiales, con diversos productos dulces, frutos y accesorios que harán de tu regalo una experiencia inolvidable." />
                </figure>
            </div>
        </div>
        ...
        <div className="containerProp">
            <h5 className='propuesta'>También contamos con propuestas corporativas ¡Consultanos!</h5>
        </div>
    </section>
  )
}
